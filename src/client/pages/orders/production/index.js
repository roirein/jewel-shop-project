...
import { ORDERS_IN_CASTING_TABLE_COLUMNS, ORDERS_IN_PRODUCTION_TABLE_COLUMNS } from '../../../const/TablesColumns'
import axios from 'axios'
import { getAuthorizationHeader, getUserToken } from '../../../utils/utils'
import {useState, useEffect} from 'react'
import { useRouter } from 'next/router'
import { CASTING_STATUS, ORDER_TYPES, PRODUCTION_STATUS } from '../../../const/Enums'
            ...
            data.push(
                {
                    ...
                    rowContent: [dataElement.orderId, ORDER_TYPES[dataElement.type], dataElement.customerName, dataElement.deadline, PRODUCTION_STATUS[dataElement.productionStatus]]
                });
        })
        setTableData(data)
    }, [originalData])
...
export const getServerSideProps = async (context) => {
    ...
    const response = await axios.get('http://localhost:3002/order/status/production', {
        headers: {
